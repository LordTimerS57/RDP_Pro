	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("../FloatingTanStackRouterDevtools-CqogiFob.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = lazy(() => import("../BaseTanStackRouterDevtoolsPanel-B-iktbLX.js"));
