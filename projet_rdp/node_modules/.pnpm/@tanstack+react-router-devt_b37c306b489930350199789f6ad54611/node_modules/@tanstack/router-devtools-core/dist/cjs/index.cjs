	...
	mount(el) {
		...
		const dispose = require_context.render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = require_context.lazy(() => Promise.resolve().then(() => require("../FloatingTanStackRouterDevtools-DZkuh9gs.cjs")));
	...
	mount(el) {
		...
		const dispose = require_context.render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = require_context.lazy(() => Promise.resolve().then(() => require("../BaseTanStackRouterDevtoolsPanel-1xUcnNGo.cjs")));
